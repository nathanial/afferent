...
require trellis from git "https://github.com/nathanial/trellis" @ "v0.0.13"
...
require reactive from git "https://github.com/nathanial/reactive" @ "v0.1.6"
...
extern_lib libafferent_native pkg := do
  ...
  buildStaticLib (pkg.staticLibDir / name) #[windowO, metalO, draw2dO, textO, bridgeO, floatBufferO, textureO]
